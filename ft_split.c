...
/*   Updated: 2022/10/11 13:47:20 by gpasquet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

void	ft_free(char **s_tab)
{
	int	i;
...
char	*ft_fill_str(char *new_s, const char *s, int s_ind, char c)
{
	int	start;		
	int	word_size;	
...
void	ft_tab_browsing(char **s_tab, const char *s, char c)
{
	int	tab_ind;
	int	i;
